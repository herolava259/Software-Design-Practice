...
{
    public class Director : Employee<Director>
    {
        public Director? _nextHandler { get; private set; }

        public Director(Director? nextHandler = null)
        {
            this._nextHandler = nextHandler;
        }
        public override void SetNextHandler(Director newHandler)
        {
